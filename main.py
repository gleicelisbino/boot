...
df_price = yf.download('BTC-USD', start='2023-01-01', end='2023-03-03'
...
df_price['Timestamp'] = df_price.index.hour
...
train_data = df_price.iloc[:train_size][['Open', 'High', 'Low', 'Close', 'Volume', 'Adj Close', 'Variation', 'Timestamp']].values
test_data = df_price.iloc[train_size:][['Open', 'High', 'Low', 'Close', 'Volume', 'Adj Close', 'Variation', 'Timestamp']].values
